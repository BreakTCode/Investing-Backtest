...
writer = xlw.Workbook('ATIDown V1 ' + str(dt.today()) + '.xlsx')
...
while Row < sheets.shape[0]:
    ...
    if IsLeapYear.is_integer():
        Meth1A[Row].FVAL = ((sheets['Close'][Row + 253] * Meth1A[Row].SHARES) / 100000) - 1
        Meth2A[Row].FVAL = ((sheets['Close'][Row + 253] * Meth2A[Row].SHARES) / 100000) - 1
    else:
        Meth1A[Row].FVAL = ((sheets['Close'][Row + 252] * Meth1A[Row].SHARES) / 100000) - 1
        Meth2A[Row].FVAL = ((sheets['Close'][Row + 252] * Meth2A[Row].SHARES) / 100000) - 1
